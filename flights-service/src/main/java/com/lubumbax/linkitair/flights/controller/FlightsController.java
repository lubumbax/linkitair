...
public class FlightsController {
    ...
    @GetMapping("/")
    public List<Flight> find(@RequestParam List<String> ids) {
        return flightsService.getFlights(ids);
    }

    @GetMapping("/from")
    public List<Flight> findFrom(@RequestParam List<String> ids) {
        return flightsService.getFlightsFrom(ids);
    }
